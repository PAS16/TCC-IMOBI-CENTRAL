...
<div class="max-w-5xl mx-auto">
    <h2 class="text-3xl font-bold mb-6 text-center">Clientes</h2>
    ...
    <table class="w-full text-left border-collapse">
        ...
        <tr class="bg-zinc-800 hover:bg-zinc-700">
            <td class="p-2 border"><?= $linha['idCLIENTE'] ?></td>
            ...
            <td class="p-2 border flex gap-2">
                <button onclick="abrirModal('editar', <?= $linha['idCLIENTE'] ?>, '<?= addslashes($linha['nome']) ?>', '<?= addslashes($linha['cpf']) ?>', '<?= addslashes($linha['telefone']) ?>', '<?= addslashes($linha['email']) ?>')" class="px-2 py-1 bg-yellow-500 rounded hover:bg-yellow-400">Editar</button>
                <button onclick="abrirModal('excluir', <?= $linha['idCLIENTE'] ?>)" class="px-2 py-1 bg-red-600 rounded hover:bg-red-500">Excluir</button>
            </td>
        </tr>
        <?php endwhile; ?>
    </table>
